...
const messages = {
  zh: {
    ...
    qa: {
      ...
      attachImage: '上传图片',
      voiceStart: '语音输入（点击开始说话）',
      voiceStop: '停止录音',
      voiceListening: '正在聆听，请说话…',
      voiceUnsupported: '当前浏览器不支持语音输入，请使用 Chrome 或 Edge 浏览器',
      voiceDenied: '麦克风权限被拒绝，请在浏览器设置中允许麦克风后重试',
  ...
  en: {
    ...
    qa: {
      ...
      attachImage: 'Image',
      voiceStart: 'Voice input (click to speak)',
      voiceStop: 'Stop recording',
      voiceListening: 'Listening, please speak…',
      voiceUnsupported: 'Voice input is not supported in this browser. Please use Chrome or Edge.',
      voiceDenied: 'Microphone permission denied. Please allow microphone access in browser settings and try again.',
